...
export const resourceTypeToIcon: Record<ResourceType, string> = {
	...
	[ResourceType.ResourceTypeBloodRune]: '/sims/wotlk/80/assets/img/blood_rune.png',
	[ResourceType.ResourceTypeFrostRune]: '/sims/wotlk/80/assets/img/frost_rune.png',
	[ResourceType.ResourceTypeUnholyRune]: '/sims/wotlk/80/assets/img/unholy_rune.png',
	[ResourceType.ResourceTypeDeathRune]: '/sims/wotlk/80/assets/img/death_rune.png',
};
