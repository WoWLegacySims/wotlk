...
export const titleIcons: Record<Class | Spec, string> = {
	[Spec.SpecBalanceDruid]: '/wotlk/BRANCH/assets/img/balance_druid_icon.png',
	[Spec.SpecFeralDruid]: '/wotlk/BRANCH/assets/img/feral_druid_icon.png',
	[Spec.SpecFeralTankDruid]: '/wotlk/BRANCH/assets/img/feral_druid_tank_icon.png',
	[Spec.SpecRestorationDruid]: '/wotlk/BRANCH/assets/img/resto_druid_icon.png',
	[Spec.SpecElementalShaman]: '/wotlk/BRANCH/assets/img/elemental_shaman_icon.png',
	[Spec.SpecEnhancementShaman]: '/wotlk/BRANCH/assets/img/enhancement_shaman_icon.png',
	[Spec.SpecRestorationShaman]: '/wotlk/BRANCH/assets/img/resto_shaman_icon.png',
	[Spec.SpecHunter]: '/wotlk/BRANCH/assets/img/hunter_icon.png',
	[Spec.SpecMage]: '/wotlk/BRANCH/assets/img/mage_icon.png',
	[Spec.SpecRogue]: '/wotlk/BRANCH/assets/img/rogue_icon.png',
	[Spec.SpecHolyPaladin]: '/wotlk/BRANCH/assets/img/holy_paladin_icon.png',
	[Spec.SpecProtectionPaladin]: '/wotlk/BRANCH/assets/img/protection_paladin_icon.png',
	[Spec.SpecRetributionPaladin]: '/wotlk/BRANCH/assets/img/retribution_icon.png',
	[Spec.SpecHealingPriest]: '/wotlk/BRANCH/assets/img/priest_icon.png',
	[Spec.SpecShadowPriest]: '/wotlk/BRANCH/assets/img/shadow_priest_icon.png',
	[Spec.SpecSmitePriest]: '/wotlk/BRANCH/assets/img/smite_priest_icon.png',
	[Spec.SpecWarlock]: '/wotlk/BRANCH/assets/img/warlock_icon.png',
	[Spec.SpecWarrior]: '/wotlk/BRANCH/assets/img/warrior_icon.png',
	[Spec.SpecProtectionWarrior]: '/wotlk/BRANCH/assets/img/protection_warrior_icon.png',
	[Spec.SpecDeathknight]: '/wotlk/BRANCH/assets/img/death_knight_icon.png',
	[Spec.SpecTankDeathknight]: '/wotlk/BRANCH/assets/img/death_knight_icon.png',
};

export const raidSimIcon = '/wotlk/BRANCH/assets/img/raid_icon.png';
