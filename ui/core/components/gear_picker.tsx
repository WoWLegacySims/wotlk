...
const emptySlotIcons: Record<ItemSlot, string> = {
	[ItemSlot.ItemSlotHead]: '/sims/wotlk/80/assets/item_slots/head.jpg',
	[ItemSlot.ItemSlotNeck]: '/sims/wotlk/80/assets/item_slots/neck.jpg',
	[ItemSlot.ItemSlotShoulder]: '/sims/wotlk/80/assets/item_slots/shoulders.jpg',
	[ItemSlot.ItemSlotBack]: '/sims/wotlk/80/assets/item_slots/shirt.jpg',
	[ItemSlot.ItemSlotChest]: '/sims/wotlk/80/assets/item_slots/chest.jpg',
	[ItemSlot.ItemSlotWrist]: '/sims/wotlk/80/assets/item_slots/wrists.jpg',
	[ItemSlot.ItemSlotHands]: '/sims/wotlk/80/assets/item_slots/hands.jpg',
	[ItemSlot.ItemSlotWaist]: '/sims/wotlk/80/assets/item_slots/waist.jpg',
	[ItemSlot.ItemSlotLegs]: '/sims/wotlk/80/assets/item_slots/legs.jpg',
	[ItemSlot.ItemSlotFeet]: '/sims/wotlk/80/assets/item_slots/feet.jpg',
	[ItemSlot.ItemSlotFinger1]: '/sims/wotlk/80/assets/item_slots/finger.jpg',
	[ItemSlot.ItemSlotFinger2]: '/sims/wotlk/80/assets/item_slots/finger.jpg',
	[ItemSlot.ItemSlotTrinket1]: '/sims/wotlk/80/assets/item_slots/trinket.jpg',
	[ItemSlot.ItemSlotTrinket2]: '/sims/wotlk/80/assets/item_slots/trinket.jpg',
	[ItemSlot.ItemSlotMainHand]: '/sims/wotlk/80/assets/item_slots/mainhand.jpg',
	[ItemSlot.ItemSlotOffHand]: '/sims/wotlk/80/assets/item_slots/offhand.jpg',
	[ItemSlot.ItemSlotRanged]: '/sims/wotlk/80/assets/item_slots/ranged.jpg',
};
			...
			return makeAnchor(
				...
				<span>
					...
					{item.factionRestriction == UIItem_FactionRestriction.ALLIANCE_ONLY && (
						<img src="/sims/wotlk/80/assets/img/alliance.png" className="ms-1" width="15" height="15" />
					)}
					{item.factionRestriction == UIItem_FactionRestriction.HORDE_ONLY && (
						<img src="/sims/wotlk/80/assets/img/horde.png" className="ms-1" width="15" height="15" />
					)}
					<br />
					{src.name}
				</span>,
