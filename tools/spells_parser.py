...
def GenSpellInfo(name: str, ids: List[int]):
    ...
    for id in ids:
        ...
        output += f"SpellID:{spellInfo.SpellID},MinLevel:{spellInfo.MinLevel},MaxLevel:{spellInfo.MaxLevel},Duration:{spellInfo.Duration},Period:{spellInfo.Period},CastTime: {spellInfo.CastTime} * time.Millisecond,BaseCost: {spellInfo.BaseCost},Effects: [3]spellinfo.SpellEffect{{"
