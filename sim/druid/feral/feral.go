...
func (cat *FeralDruid) MissChance() float64 {
	...
	miss := at.BaseMissChance - cat.Claw.PhysicalHitChance(at)
	dodge := at.BaseDodgeChance - cat.Claw.ExpertisePercentage() - cat.CurrentTarget.PseudoStats.DodgeReduction
	return miss + dodge
}
